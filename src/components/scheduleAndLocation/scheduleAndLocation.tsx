  ...
  return (
    ...
    <div className="row">
         ...
         <div className="col-lg-3 mx-auto">
            <p>8525 Bissonnet St</p>
            <p>Houston, TX, 77041</p>
            <p>Number: 281-854-7211</p>
            <p>Email: phonehuttx@gmail.com</p>
            <span>
              <span style={{paddingRight: '2rem'}}>
                <a href='https://www.instagram.com/phonehuttx/?utm_source=ig_web_button_share_sheet'>
               ...
               <a href='https://www.facebook.com/share/1Aan2T6KBq/?mibextid=wwXIfr'>
        ...
        <div className="col-lg-3 mx-auto">
            ...
            <tr>
                ...
                {days.map((day) => (
                    <tr key={day}>
                        <td style={{ paddingRight: '2rem' }}>{day.day}</td>
                        <td>{day.hours}</td>
                    </tr>
                ))}
                </tbody>
